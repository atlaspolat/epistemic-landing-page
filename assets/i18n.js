...
(function () {
	...
	var DE = {
		...
		"l.hero.lead": "Lawsec hält Ihre Mandanten über den Stand ihres Falls auf dem Laufenden, beantwortet ihre Fragen, erfasst die Erstaufnahme und eskaliert die komplexen Angelegenheiten an Sie — rund um die Uhr, in der Sprache Ihrer Mandanten, auf den Kanälen, die sie ohnehin nutzen.",
		...
		"l.hero.m3": "<span class=\"tick\">✓</span> Übergabe an Menschen",
		...
		"l.how.2h": "Teilt den aktuellen Stand", "l.how.2p": "Lawsec antwortet sofort mit dem aktuellen Stand der Sache — nächste Termine, Einreichungen und Offenes — fundiert auf Ihren Kanzleidaten.",
		"l.how.3h": "Erfasst & bucht", "l.how.3p": "Es erfasst neue Details, qualifiziert neue Mandate und bucht Folgetermine direkt in Ihren Kalender.",
		"l.how.4h": "Eskaliert an Sie", "l.how.4p": "Alles Komplexe oder Sensible wird mit einer sauberen, strukturierten Zusammenfassung an die richtige Person übergeben.",

		"l.cap.index": "02 — Fähigkeiten",
		"l.cap.title": "Ein Sekretär, der nie Feierabend macht.",
		"l.cap.intro": "Alles, was eine großartige Empfangskraft bei der Routinearbeit leistet — sofort, konsistent und zu jeder Stunde.",
		"l.cap.1h": "Erstaufnahme rund um die Uhr", "l.cap.1p": "Erfassen Sie jede Anfrage im Moment ihres Eingangs — keine verpassten Anrufe, keine Lücken außerhalb der Geschäftszeiten.",
		...
		"l.cap.9h": "Schutzmechanismen für Übergabe", "l.cap.9p": "Kennt seine Grenzen und eskaliert sensible Angelegenheiten mit Kontext an einen Menschen.",

		"l.why.index": "03 — Warum Kanzleien es nutzen",
		"l.why.title": "Gewinnen Sie die Mandanten, die Sie derzeit verlieren.",
		"l.why.intro": "Die meisten Kanzleien verlieren Mandate, weil niemand schnell genug geantwortet hat. Lawsec schließt diese Lücke.",
		"l.why.1h": "Keinen Mandanten verpassen", "l.why.1p": "Jede Anfrage erhält eine sofortige, professionelle Antwort — damit Mandate nicht zur Kanzlei abwandern, die zuerst geantwortet hat.",
		"l.why.2h": "Abdeckung außerhalb der Geschäftszeiten", "l.why.2p": "Abende, Wochenenden, Feiertage — Lawsec ist im Dienst, wenn Ihr Büro es nicht ist.",
		"l.why.3h": "Konsistenter, professioneller Ton", "l.why.3p": "Jeder Mandant erhält dieselbe korrekte, höfliche Antwort, im Stil Ihrer Kanzlei.",
		"l.why.4h": "Kein Hinterherlaufen bei Updates", "l.why.4p": "Mandanten rufen und mailen nicht mehr wegen Updates — Lawsec übernimmt das, sodass Anwälte zur abrechenbaren Arbeit zurückkehren, statt sich zu wiederholen.",
